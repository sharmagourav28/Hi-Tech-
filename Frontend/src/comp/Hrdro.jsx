...
const Hydro = () => {
  ...
  useEffect(() => {
    ...
    <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2'>
        ...
        {/* Sub Headings */}
        <div className='text-center font-semibold py-2'>Long Root</div>
        <div className='text-center font-semibold py-2'>Long Final</div>
        <div className='text-center font-semibold py-2'>Round Root</div>
        <div className='text-center font-semibold py-2'>Round Final</div>
        <div className='text-center font-semibold py-2'>Sockets</div>
        <div className='text-center font-semibold py-2'>Attachment</div>
